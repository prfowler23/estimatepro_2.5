...
import { generateFollowUpPlan, generateFollowUpEmail, generateCallScript, analyzeEngagement } from '../../../../lib/ai/follow-up-automation';
  ...
  try {
    ...
    switch (action) {
      ...
      case 'analyze_engagement':
        ...
        result = await analyzeEngagement(data.extractedData, data.recentActivity);
        break;
  ...
  return NextResponse.json({
    ...
    supported_actions: {
      ...
      generate_email: {
        ...
        email_types: ['initial', 'reminder', 'value_add', 'objection_handling', 'final']
      },
      generate_script: {
