-- ============================================
-- FIXED PERFORMANCE INDEXES FOR CORE TABLES
-- ============================================
...
-- Workflow analytics table indexes (FIXED - no flow_id column)
...
-- Composite indexes for common joins (only if table exists)
DO $$ 
BEGIN
...
-- Integration sync logs (only if table exists)
DO $$ 
BEGIN
