...
-- Add customers manually or through the application interface
-- INSERT INTO customers (name, email, phone, company_name)
-- VALUES 
--   ('Sample Customer 1', 'customer1@company.com', '555-0123', 'Company Name 1'),
--   ('Sample Customer 2', 'customer2@company.com', '555-0456', 'Company Name 2')
