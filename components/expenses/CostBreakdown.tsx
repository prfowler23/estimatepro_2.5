          ...
          <TabsContent value="table" className="space-y-4">
                        ...
                        <React.Fragment key={service}>
                          <tr className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-right">
                              ${directCosts.equipment.toFixed(2)}
                            </td>
                            <td className="px-4 py-3 text-right">
                              ${directCosts.materials.toFixed(2)}
                            </td>
                            <td className="px-4 py-3 text-right">
                              ${directCosts.labor.toFixed(2)}
                            </td>
                            <td className="px-4 py-3 text-right">
                              ${directCosts.other.toFixed(2)}
                            </td>
                            <td className="px-4 py-3 text-right font-medium">
                              ${directCosts.total.toFixed(2)}
                            </td>
                            <td className="px-4 py-3 text-right font-medium">
                              ${totalMarkedUp.toFixed(2)}
                            </td>
            ...
            {serviceBreakdown.some((s) => s.profitMargin < 20) && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Some services have profit margins below 20%. Consider
                  adjusting pricing or reducing costs.
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm">
                        {costPercentages.equipment.toFixed(1)}%
                      </span>
                    </div>
                    <Progress
                      value={costPercentages.equipment}
                      className="h-3"
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm">
                        {costPercentages.materials.toFixed(1)}%
                      </span>
                    </div>
                    <Progress
                      value={costPercentages.materials}
                      className="h-3"
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm">
                        {costPercentages.labor.toFixed(1)}%
                      </span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm">
                        {costPercentages.other.toFixed(1)}%
                      </span>
                    </div>
