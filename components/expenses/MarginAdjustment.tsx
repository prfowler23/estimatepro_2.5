...
const MARGIN_GUIDELINES = {
  equipment: {
    ...
    max: 30,
    target: 15,
    rationale: "Cover rental risks and logistics",
  },
  materials: {
    min: 10,
    max: 35,
    target: 20,
    rationale: "Account for waste and price volatility",
  },
  labor: {
    min: 20,
    max: 60,
    target: 35,
    rationale: "Cover overhead, benefits, and expertise",
  },
  other: {
    min: 5,
    max: 25,
    target: 15,
    rationale: "Miscellaneous costs and contingencies",
  },
};
      ...
      <CardContent>
        {showGuidelines && (
          <Alert className="mb-4">
            ...
            <AlertDescription>
              <strong>Margin Guidelines:</strong> Equipment (15%), Materials
              (20%), Labor (35%), Other (15%). Adjust based on project risk,
            ...
            <TabsContent value="adjust" className="space-y-4">
              ...
              <div className="space-y-6">
                {Object.entries(tempMargins).map(([category, value]) => {
                  const guidelines =
                    MARGIN_GUIDELINES[category as keyof CostMargins];
                  return (
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p
                        className={`font-medium ${impact.difference >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                        {impact.difference >= 0 ? "+" : ""}$
                        {impact.difference.toFixed(2)}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Change:</p>
                      <p
                        className={`font-medium ${impact.percentChange >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                  ...
                  <div className="mt-3 pt-3 border-t">
                    <p className="text-sm">
                      ...
                      <span className="font-medium text-green-600">
                        ${impact.profit.toFixed(2)}
                      </span>
                      <span className="text-gray-600 ml-2">
                        ({((impact.profit / impact.new) * 100).toFixed(1)}%
                        margin)
                      </span>
                    </p>
                  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(margins).map(([category, value]) => (
                ...
                >
                  ...
                  <p
                    className={`text-2xl font-bold ${getMarginColor(category as keyof CostMargins, value)}`}
                  >
                    {value}%
                  </p>
            ...
            {Object.entries(margins).some(([category, value]) => {
              ...
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Some margins are below recommended minimums. This may impact
                  profitability and ability to handle project risks.
                </AlertDescription>
              </Alert>
            )}
          </div>
