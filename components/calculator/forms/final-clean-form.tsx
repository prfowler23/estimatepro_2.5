  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        <Brush className="h-5 w-5 text-primary-action" />
        <h2 className="text-2xl font-bold">Final Clean Calculator</h2>
      </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Total glass area for window count calculation
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
