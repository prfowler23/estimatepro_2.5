        ...
        <div className="flex items-center space-x-2">
          {currentEstimate?.status && (
            <Badge className={getStatusColor(currentEstimate.status)}>
              {currentEstimate.status.charAt(0).toUpperCase() +
                currentEstimate.status.slice(1)}
            </Badge>
          )}
          {!isEditing && (
            ...
            <CardContent>
              {services.length === 0 ? (
                <p className="text-muted-foreground text-center py-8">
                  No services added yet. Click &quot;Add Service&quot; to get
                  started.
                </p>
              ) : (
                  ...
                  {notesContent ? (
                    <div
                      dangerouslySetInnerHTML={{
                        __html: sanitizeHtml(notesContent),
                      }}
                    />
                  ) : (
