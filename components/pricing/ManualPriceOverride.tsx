...
export function ManualPriceOverride({
  ...
  const handleSubmit = () => {
    ...
    const category =
      reasonCategories.find((cat) => cat.id === selectedCategory)?.name || "";
      ...
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Adjust the final price based on specific customer circumstances or
          ...
          <TabsContent value="override" className="space-y-6">
            ...
            {validation.requiresApproval && (
              <Alert>
                ...
                <AlertDescription>
                  This price override requires {validation.approvalLevel}{" "}
                  approval before the estimate can be finalized.
                </AlertDescription>
              </Alert>
            )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center border-t pt-2">
                      ...
                      <span
                        className={`font-bold ${
                          calculatedPrice < marketMedian
                            ? "text-green-600"
                            : "text-red-600"
                        }`}
                      >
                        {((calculatedPrice / marketMedian - 1) * 100).toFixed(
                          1,
                        )}
                        %
                      </span>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center border-t pt-2">
                      ...
                      <span
                        className={`font-bold ${
                          calculatedPrice <= customerBudget
                            ? "text-green-600"
                            : "text-red-600"
                        }`}
                      >
