        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="analysis" className="space-y-6">
            ...
            <Alert className={riskAssessment.color}>
              ...
              <AlertDescription>
                <strong>{riskAssessment.level} Risk Discount:</strong>{" "}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`font-bold ${
                          requestedPrice < competitorPrice
                            ? "text-green-600"
                            : "text-red-600"
                        }`}
                      >
          ...
          <TabsContent value="approval" className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {onRequestHigherApproval &&
                discountPercentage > currentApprover.limit && (
                  <Button
                    variant="outline"
          ...
          <TabsContent value="history" className="space-y-6">
            {customerHistory ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold">
                          {customerHistory.avgDiscount.toFixed(1)}%
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Badge
                          className={
                            customerHistory.paymentHistory === "excellent"
                              ? "bg-green-600"
                              : customerHistory.paymentHistory === "good"
                                ? "bg-blue-600"
                                : customerHistory.paymentHistory === "fair"
                                  ? "bg-yellow-600"
                                  : "bg-red-600"
                          }
                        >
              ...
              <Alert>
                ...
                <AlertDescription>
                  No customer history available. This may be a new customer or
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        ...
                        <span>
                          <strong>0-10%:</strong> Sales Manager approval
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Shield className="w-4 h-4 text-purple-500" />
                        <span>
                          <strong>10-20%:</strong> Sales Director approval
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                        <TrendingDown className="w-4 h-4 text-orange-500" />
                        <span>
                          <strong>20-30%:</strong> VP of Sales approval
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                        <AlertTriangle className="w-4 h-4 text-red-500" />
                        <span>
                          <strong>30%+:</strong> CEO approval required
                        </span>
                      </li>
                    </ul>
                  </div>
