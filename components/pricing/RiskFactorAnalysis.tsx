        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="factors" className="space-y-4">
            ...
            {riskFactors.map((factor) => (
              <Card
                key={factor.id}
                className={`border ${getRiskColor(factor.severity)}`}
              >
                    ...
                    {factor.costImpact && (
                      <div>
                        ...
                        <p className="font-medium">
                          ${factor.costImpact.toLocaleString()}
                        </p>
                      </div>
                    )}
                    {factor.timeImpact && (
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-blue-600">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Verify insurance coverage for all identified risks
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 mt-0.5" />
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 mt-0.5" />
                        <span>
                          Conduct site inspection for access verification
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-blue-600">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 mt-0.5" />
                        <span>
                          Regular weather monitoring and contingency planning
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 mt-0.5" />
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 mt-0.5" />
                        <span>
                          Maintain contingency budget for unexpected issues
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {riskFactors
                    .filter(
                      (factor) =>
                        factor.contractClauses &&
                        factor.contractClauses.length > 0,
                    )
                    .map((factor) => (
          ...
          <TabsContent value="recommendations" className="space-y-6">
            ...
            {riskAssessment.level === "Critical" && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  <strong>Critical Risk Level Detected:</strong> This project
                  carries significant risks that may impact profitability and
                  completion. Consider declining or restructuring the project
                  scope.
                </AlertDescription>
              </Alert>
            )}
              ...
              <CardContent>
                <div className="space-y-4 text-yellow-700">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • Apply {totalImpact.toFixed(1)}% risk premium to base
                        pricing
                      </li>
                      <li>
                        • Consider requiring 25-50% deposit for high-risk
                        projects
                      </li>
                      <li>
                        • Include escalation clauses for material cost increases
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>
                        • Develop detailed contingency plans for top 3 risks
                      </li>
                      <li>
                        • Schedule regular client communication checkpoints
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • Implement additional safety protocols for high-risk
                        work
                      </li>
                      <li>
                        • Document all risk-related decisions and communications
                      </li>
                      <li>
                        • Consider third-party inspections for critical work
                        phases
                      </li>
                    </ul>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <p className="text-2xl font-bold text-blue-600">
                      {(
                        (projectValue * (1 + totalImpact / 100)) /
                        totalRiskScore
                      ).toLocaleString()}
                    </p>
