        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="text-xs text-text-secondary" id="ai-saved-hours">
                AI saved this month
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="text-xs text-text-secondary" id="photo-accuracy">
            ...
            >
              ...
              <div className="text-xs text-text-secondary" id="automation-rate">
                Automation rate
              </div>
            </div>
          </div>
