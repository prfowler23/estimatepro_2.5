...
- **GEMINI.md** (this file): Comprehensive project documentation, architecture overview, and development setup
...
**Documentation**: Update GEMINI.md for architecture changes, JSDoc for complex functions
...
Gemini: ALWAYS run `npm run fmt && npm run lint` after you edit or create files.
