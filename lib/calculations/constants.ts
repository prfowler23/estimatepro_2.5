...
export const OTHER_RATES = {
  ...
  softWashing: 0.45,
  biofilmRemoval: { min: 0.75, max: 1.00 },
} as const
...
export const MATERIAL_COSTS = {
  standardCleaner: 2.50, // per gallon
  premiumCleaner: 4.75, // per gallon
  sealer: 12.50, // per gallon
  restorationCompound: 8.25, // per gallon
  granitePolish: 15.00, // per gallon
} as const
...
export const PROFIT_MARGINS = {
  ...
  frameRestoration: 0.40,    // 40%
  pressureWashing: 0.38,     // 38%
  softWashing: 0.42,         // 42%
  finalClean: 0.40,          // 40%
  parkingDeck: 0.35,         // 35%
  graniteReconditioning: 0.50, // 50%
