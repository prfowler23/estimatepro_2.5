export const SERVICE_DEFINITIONS = {
  PW: {
    ...
    safetyConsiderations: ['Fall protection', 'Eye protection', 'Non-slip footwear'],
  ...
  GR: {
    ...
    description: 'Specialized restoration to remove stains, scratches, and oxidation from glass',
    basePrice: '$5-35/window',
    typicalDuration: '2-4 days',
    requirements: ['Specialized equipment', 'Skilled technicians'],
    equipment: ['Glass polishing compounds', 'Restoration tools', 'Protective materials'],
    safetyConsiderations: ['Chemical exposure protection', 'Precision work safety'],
  ...
  FR: {
    ...
    equipment: ['Sanders', 'Brushes', 'Restoration chemicals', 'Protective coatings'],
    safetyConsiderations: ['Lead paint precautions', 'Chemical handling', 'Dust protection'],
  ...
  HD: {
    id: 'HD',
    name: 'High Dusting',
    description: 'Removal of dust and debris from elevated surfaces and fixtures',
    ...
    safetyConsiderations: ['Fall protection', 'Respiratory protection', 'Ladder safety'],
  ...
  SW: {
    ...
    equipment: ['Low-pressure pumps', 'Chemical applicators', 'Protective sheeting'],
    safetyConsiderations: ['Chemical handling', 'Environmental protection', 'PPE required'],
  ...
  PD: {
    ...
    equipment: ['Industrial pressure washers', 'Floor scrubbers', 'Degreasing agents'],
    safetyConsiderations: ['Traffic management', 'Slip hazards', 'Chemical exposure'],
    bestFor: ['Concrete decks', 'Oil stain removal', 'Structural maintenance'],
    restrictions: ['Traffic disruption', 'Weather dependent', 'Drainage requirements']
  },
  GRC: {
    id: 'GRC',
    name: 'Granite Reconditioning',
    description: 'Restoration and polishing of granite and natural stone surfaces',
    basePrice: '$1.75/sq ft',
    typicalDuration: '2-3 days',
    requirements: ['Specialized stone care products', 'Skilled technicians'],
    equipment: ['Diamond polishing pads', 'Stone cleaners', 'Sealers', 'Polishing machines'],
    safetyConsiderations: ['Silica dust protection', 'Chemical handling', 'Heavy equipment'],
  ...
  FC: {
    ...
    equipment: ['Variety of cleaning tools', 'Detailing supplies', 'Touch-up materials'],
...
export function getServicesByComplexity(complexity: keyof typeof SERVICE_COMPLEXITY) {
